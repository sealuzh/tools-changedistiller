...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.ARRAY_INITIALIZER;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.ARRAY_TYPE;
...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.BLOCK;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.BOOLEAN_LITERAL;
...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.INFIX_EXPRESSION;
...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.PARAMETER;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.PARAMETERIZED_TYPE;
...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.QUALIFIED_NAME;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.QUALIFIED_TYPE;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.RETURN_STATEMENT;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.SIMPLE_NAME;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.SIMPLE_TYPE;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.STRING_LITERAL;
...
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.TYPE_LITERAL;
import static org.evolizer.changedistiller.model.classifiers.java.JavaEntityType.TYPE_PARAMETER;
...
public final class JavaASTHelper implements ASTHelper {
    ...
    @Override
    public boolean isASTNodeUsableForSourceCodeChange(Object node) {
        if (node instanceof Node) {
            return ((Node) node).getLabel().isValidChange();
        }
        throw new RuntimeException("Unkown node type: " + node.getClass());
    }
}
